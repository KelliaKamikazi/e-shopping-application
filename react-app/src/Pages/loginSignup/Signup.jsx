        ...
        <div className='container col-md-6' style={{ minHeight: "80vh" }}>
            ...
            <form className="row g-3" onSubmit={createAccount}>
                ...
                <div className="col-md-6">
                    ...
                    <input type="number" className="form-control" id="phoneNumber" name='phoneNumber' value={userDetails.phoneNumber} onChange={inputHandler} placeholder='25078xxxxxx' />
                </div>
                ...
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="city" name='city' placeholder='Kigali City' value={userDetails.city} onChange={inputHandler} />
                </div>
                <div className="col-md-6">
                    <label htmlFor="district" className="form-label">District</label>
                    <input type="text" className="form-control" id="district" name='district' placeholder='Gasabo' value={userDetails.district} onChange={inputHandler} />
                </div>
                <div className="col-md-6">
                    <label htmlFor="state" className="form-label">State</label>
                    <input type="text" className="form-control" id="state" name='state' placeholder='Rwanda' value={userDetails.state} onChange={inputHandler} />
                </div>
                <div className="col-md-6">
